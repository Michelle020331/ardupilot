...
## UART Mapping
 ...
 - SERIAL2 -> UART6 (Telem2)
 - SERIAL3 -> UART1 (GPS1)
 - SERIAL4 -> UART3 (GPS2)
 - SERIAL5 -> UART8 (USER) TX only
 - SERIAL6 -> UART4 (RS232)
...
RC input is configured on the RCIN pin, at one end of the servo rail. This pin supports all unidirectional RC protocols.

## PWM Output

The VUAV-V7pro supports up to 14 PWM outputs,support all PWM protocols as well as DShot. All 14 PWM outputs have GND on the top row, 5V on the middle row and signal on the bottom row.
